...
# Since both containers run on the same Docker network, "backend" resolves to
# the backend container via Docker's internal DNS
...
product_id_char = st.selectbox("Product Id Char (Product Category Prefix)", ["FD", "DR", "NC"])
store_age_years = st.number_input("Store Age (Years)", min_value=0, step=1, value=16)
